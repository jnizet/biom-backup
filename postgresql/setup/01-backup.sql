...
70366	1055	IMAGE	body.bodyElements.5.image.imageElement	\N	2667	Gecko vert de Madagascar (*Phelsuma grandis*), La Réunion © Philippe Gourdain - INPN	\N	f
70367	1055	TEXT	body.bodyElements.4.questionAnswer.question	En quelques siècles, le profil herpétologique de l’île a donc été complètement modifié ?	\N	\N	\N	f
...
70368	1055	TEXT	body.bodyElements.0.questionAnswer.question	Nature Océan Indien est spécialisée sur la conservation des reptiles. Quelle sont les espèces qu’on rencontre à l’île de La Réunion ? 	\N	\N	\N	f
70369	1055	CHECKBOX	presentation.shadowed	false	\N	\N	\N	f
70370	1055	TEXT	body.bodyElements.2.questionAnswer.response	<strong>Par le passé, de nombreuses autres espèces indigènes et endémiques peuplaient l’île </strong>: la Tortue géante des Mascareignes par exemple ! En se basant sur les documents historiques, on a estimé qu’il y avait environ un million d’individus de cette tortue terrestre à l’arrivée des humains sur l’île au 17<sup>e</sup> siècle. Malheureusement, les premiers occupants de l’île se sont allégrement servis. Il n’y avait pas d’écologues à l’époque mais on a retrouvé des lettres du 18<sup>e</sup> siècle d’un officiel qui avait écrit au roi de France pour dénoncer l’utilisation outrancière des tortues géantes, notamment pour nourrir les cochons ! Elles étaient aussi utilisées comme source de nourriture sur les bateaux, car elles pouvaient rester très longtemps sans boire ni manger. Les rats et les cochons ont dû finir le travail en prédatant les œufs, <strong>et en très peu d’années de présence humaine à La Réunion, les tortues géantes sont devenues un souvenir.</strong>  \n<br>\nParmi les espèces éteintes, on trouve également tous les scinques indigènes et les geckos nocturnes du genre *Nactus*, dont certaines espèces sont encore présentes à l’île Maurice.\n<br> 	\N	\N	\N	f
70371	1055	TEXT	interviewee.presentation	Nature Océan Indien	\N	\N	\N	f
70372	1055	TEXT	presentation.name	« A La Réunion, il ne reste que deux reptiles indigènes et endémiques »	\N	\N	\N	f
70373	1055	IMAGE	body.bodyElements.3.image.imageElement	\N	2663	Gecko vert des Hauts (*Phelsuma borbonica*), La Réunion © D. Martiré - INPN	\N	f
70374	1055	TEXT	presentation.author	Doriane Blottière	\N	\N	\N	f
70375	1055	TEXT	body.bodyElements.7.questionAnswer.question	Au delà de la prédation et de la compétition causées par ces reptiles introduits, les geckos endémiques sont-ils confrontés à d'autres pressions ? 	\N	\N	\N	f
...
SELECT pg_catalog.setval('public.page_element_seq', 70621, true);
